...
- T036 now provides protected Task create/list/get routes under `/api/v1/tasks`.
  Login remains outside HTTP scope; principal resolution and authorization use
  the existing service and FastAPI-dependency layers.
