...
- No TaskPilot HTTP endpoint exists yet (no login endpoint, no `/me`, no `/api/v1`). Login, principal resolution, and authorization are service and FastAPI-dependency layers.
