...
## Exact Allowed Files
Only process/tasks/T011.md implementation targets, their focused tests, and stale documentation named below. No source code is authorized by this planning card.
...
.env.example;.env;.gitignore;src/core/settings.py
...
.env.example, docs/DEVELOPER_GUIDE.md, process/PROGRESS_LOG.md

## Task-specific constraint
Never read or copy secret values from .env; keep .env ignored.
