...
## Phase 7 Task Cards — Observability

| Task | Purpose | Model | Review | Depends On |
|---|---|---|---|---|
| T090 | Trace data model decision / ADR-009 | STRONG planning | Planning Strong Review | Phase 6 |
| T091 | AgentRun persistence | LOW_COST/STANDARD | Strong Review | T090 |
| T092 | ToolCall persistence | LOW_COST/STANDARD | Strong Review | T090 |
| T093 | Correlation propagation | STANDARD | Strong Review | T091, T092 |
...
DAG: `T090 → (T091, T092) → T093 → (T094, T095) → T096 → T097 → T098`. T092 owns persisted-payload redaction tests, T097 owns timeline-response redaction tests, and T098 audits their evidence; no T099 is created.
