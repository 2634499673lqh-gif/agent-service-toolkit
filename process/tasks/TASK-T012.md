...
## Exact Allowed Files
Only process/tasks/T012.md implementation targets, their focused tests, and stale documentation named below. No source code is authorized by this planning card.
...
src/core/settings.py;src/memory/postgres.py;tests/core/test_settings.py

## Task-specific focused command
uv run pytest tests/core/test_settings.py -q, then uv run pytest

## Task-specific model
Implementation: STANDARD

## Task-specific allowed files
src/core/settings.py, tests/core/test_settings.py, docs/DEVELOPER_GUIDE.md, process/PROGRESS_LOG.md

## Task-specific constraint
Keep Pydantic Settings; do not redesign providers.
